...
from src.captcha_solver.captcha_solver import extract_base64_data, identifyVerificationCodeWithAI
from src.config import CLCRC_HOME_URL, CLCRC_PASSWORD, CLCRC_USERNAME, SSO_USERNAME, SSS_OPASSWORD
...
def clcrc_login():
    ...
    try:
        ...
        if "authcenter/ActionAuthChain" in current_url:
            ...
            username_input.send_keys(SSO_USERNAME)
            password_input = driver.find_element(By.ID, "j_password")
            password_input.send_keys(SSS_OPASSWORD)
